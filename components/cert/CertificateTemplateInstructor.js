                ...
                <g>
                    <g>
                        <image
                            ...
                            xlinkHref="/certificate-templates/instructor_certificate.png"
                        />
                    </g>
                </g>
                <g>
                ...
                >
                    {line1.split("\n").map((str, index, array) => (
                        <tspan
                            key={index}
                            x="155"
                            y={490 + index * 40} // Center vertically based on the number of lines
                        >
                            {str}
                        </tspan>
                    ))}
                ...
                >
                    {leadUniversity.split("\n").map((str, index, array) => (
                        <tspan
                            key={index}
                            x="160"
                            y={870 + (index - (array.length - 1) / 2) * 14} // Center vertically based on the number of lines
